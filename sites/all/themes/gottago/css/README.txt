...
To use these stylesheets, rename the files and gottago with the name of your theme.
...
gottago-alpha-default-narrow.css  
...
gottago-alpha-default-normal.css
...
gottago-alpha-default-wide.css
